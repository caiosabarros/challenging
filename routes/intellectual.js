...
// POST / intellectual
router.post('/', isAuthenticated, rules[0], validate, intellectualController.createIntellectual);
// PUT / intellectual / { list_identifier }
router.put('/:listId', isAuthenticated, rules[0], validate, intellectualController.updateIntellectual);
// PUT / intellectual / { list_identifier }
router.put('/:listId/:username', isAuthenticated, rules[0], validate, intellectualController.updateIntellectualWithNewUser);
